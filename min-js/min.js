          ...
          if (
            ...
            if (i && i.prototype.applyConstraints) {
              ...
              i.prototype.applyConstraints = function (e) {
                return (
                  "audio" === this.kind && "object" === r(e) && ((e = JSON.parse(JSON.stringify(e))), a(e, "autoGainControl", "mozAutoGainControl"), a(e, "noiseSuppression", "mozNoiseSuppression")),
                  u.apply(this, [e])
                );
              };
            }
                    ...
                    switch (t.label) {
                      ...
                      case 2:
                        (a = t.sent()),
                          ...
                          this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (a.sdp = this.connection.options.sdpTransform(a.sdp) || a.sdp),
                          (t.label = 3);
                      case 3:
                      ...
                      case 4:
                        return (
                          ...
                          (s = { sdp: a, type: this.connection.type, connectionId: this.connection.connectionId, metadata: this.connection.metadata, browser: i.util.browser }),
                          this.connection.type === c.ConnectionType.Data && ((d = this.connection), (s = e(e({}, s), { label: d.label, reliable: d.reliable, serialization: d.serialization }))),
                    ...
                    switch (t.label) {
                      ...
                      case 2:
                        (o = t.sent()),
                          ...
                          this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (o.sdp = this.connection.options.sdpTransform(o.sdp) || o.sdp),
                          (t.label = 3);
                      case 3:
          ...
          f = (function (o) {
            function i(e, n) {
              ...
              return (
                ...
                c._options.path && ("/" !== c._options.path[0] && (c._options.path = "/" + c._options.path), "/" !== c._options.path[c._options.path.length - 1] && (c._options.path += "/")),
                void 0 === c._options.secure && c._options.host !== s.util.CLOUD_HOST ? (c._options.secure = s.util.isSecure()) : c._options.host == s.util.CLOUD_HOST && (c._options.secure = !0),
            ...
            return (
                ...
                switch (o) {
                  ...
                  case u.ServerMessageType.Offer:
                    ...
                    if (((_ = this.getConnection(s, c)) && (_.close(), a.default.warn("Offer received for existing Connection ID:" + c)), i.type === u.ConnectionType.Media))
                      ...
                      (_ = new d.DataConnection(s, this, { connectionId: c, _payload: i, metadata: i.metadata, label: i.label, serialization: i.serialization, reliable: i.reliable })),
              ...
              (i.prototype.call = function (e, t, n) {
                if ((void 0 === n && (n = {}), this.disconnected))
                  return (
                    a.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                    void this.emitError(u.PeerErrorType.Disconnected, "Cannot connect to new Peer after disconnecting from server.")
                  );
                if (t) {
                  n._stream = t;
